...
d3.csv("mainstream_sorted.csv", function(data) {
...
_.times(squaresColumn, function(n) {
  ...
  .append('rect')
    ...
    d3.select("#popularityView").on("change", function(){
        ...
        d3.select("#mf_square_count").text(Math.round((mf_square_count/reds)*100) + "%");
        d3.select("#tf_square_count").text(Math.round((tf_square_count/data_count)*100) + "%");
        d3.select("#mt_square_count").text(Math.round((mt_square_count/data_count)*100) + "%");
        d3.select("#nf_square_count").text(Math.round((nf_square_count/data_count)*100) + "%");
        if(pop){
        ...
        d3.select("#mf_square_count").text(Math.round((mf_square_count/data_count)*100) + "%");
        d3.select("#tf_square_count").text(Math.round((tf_square_count/data_count)*100) + "%");
        d3.select("#mt_square_count").text(Math.round((mt_square_count/data_count)*100) + "%");
        d3.select("#nf_square_count").text(Math.round((nf_square_count/data_count)*100) + "%");
});